...
set "AMENT_ENVIRONMENT_HOOKS[mcd_interfaces]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mcd_interfaces] "%AMENT_CURRENT_PREFIX%\share\mcd_interfaces\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mcd_interfaces] "%AMENT_CURRENT_PREFIX%\share\mcd_interfaces\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mcd_interfaces] "%AMENT_CURRENT_PREFIX%\share\mcd_interfaces\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[mcd_interfaces]:;=";"%") do (
    call:call_file %%f
  )

...
set "AMENT_ENVIRONMENT_HOOKS[rqt_srv]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_srv] "%AMENT_CURRENT_PREFIX%\share\rqt_srv\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_srv] "%AMENT_CURRENT_PREFIX%\share\rqt_srv\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_srv] "%AMENT_CURRENT_PREFIX%\share\rqt_srv\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_srv]:;=";"%") do (
    call:call_file %%f
  )

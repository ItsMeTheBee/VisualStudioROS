...
set "AMENT_ENVIRONMENT_HOOKS[move_base_msgs]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[move_base_msgs] "%AMENT_CURRENT_PREFIX%\share\move_base_msgs\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[move_base_msgs] "%AMENT_CURRENT_PREFIX%\share\move_base_msgs\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[move_base_msgs] "%AMENT_CURRENT_PREFIX%\share\move_base_msgs\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[move_base_msgs]:;=";"%") do (
    call:call_file %%f
  )

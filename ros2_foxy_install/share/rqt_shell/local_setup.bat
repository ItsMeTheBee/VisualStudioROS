...
set "AMENT_ENVIRONMENT_HOOKS[rqt_shell]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_shell] "%AMENT_CURRENT_PREFIX%\share\rqt_shell\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_shell] "%AMENT_CURRENT_PREFIX%\share\rqt_shell\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_shell] "%AMENT_CURRENT_PREFIX%\share\rqt_shell\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_shell]:;=";"%") do (
    call:call_file %%f
  )

...
set "AMENT_ENVIRONMENT_HOOKS[rqt_publisher]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_publisher] "%AMENT_CURRENT_PREFIX%\share\rqt_publisher\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_publisher] "%AMENT_CURRENT_PREFIX%\share\rqt_publisher\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_publisher] "%AMENT_CURRENT_PREFIX%\share\rqt_publisher\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_publisher]:;=";"%") do (
    call:call_file %%f
  )

...
set "AMENT_ENVIRONMENT_HOOKS[rqt_service_caller]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_service_caller] "%AMENT_CURRENT_PREFIX%\share\rqt_service_caller\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_service_caller] "%AMENT_CURRENT_PREFIX%\share\rqt_service_caller\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_service_caller] "%AMENT_CURRENT_PREFIX%\share\rqt_service_caller\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_service_caller]:;=";"%") do (
    call:call_file %%f
  )

...
set "AMENT_ENVIRONMENT_HOOKS[rqt_plot]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_plot] "%AMENT_CURRENT_PREFIX%\share\rqt_plot\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_plot] "%AMENT_CURRENT_PREFIX%\share\rqt_plot\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_plot] "%AMENT_CURRENT_PREFIX%\share\rqt_plot\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_plot]:;=";"%") do (
    call:call_file %%f
  )

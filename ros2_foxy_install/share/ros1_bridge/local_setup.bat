...
set "AMENT_ENVIRONMENT_HOOKS[ros1_bridge]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros1_bridge] "%AMENT_CURRENT_PREFIX%\share\ros1_bridge\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros1_bridge] "%AMENT_CURRENT_PREFIX%\share\ros1_bridge\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros1_bridge]:;=";"%") do (
    call:call_file %%f
  )

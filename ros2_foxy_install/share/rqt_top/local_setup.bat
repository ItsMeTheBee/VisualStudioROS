...
set "AMENT_ENVIRONMENT_HOOKS[rqt_top]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_top] "%AMENT_CURRENT_PREFIX%\share\rqt_top\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_top] "%AMENT_CURRENT_PREFIX%\share\rqt_top\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_top] "%AMENT_CURRENT_PREFIX%\share\rqt_top\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_top]:;=";"%") do (
    call:call_file %%f
  )

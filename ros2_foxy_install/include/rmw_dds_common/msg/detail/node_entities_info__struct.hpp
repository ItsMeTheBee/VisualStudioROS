...
struct NodeEntitiesInfo_
{
  ...
  using _reader_gid_seq_type =
    std::vector<rmw_dds_common::msg::Gid_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmw_dds_common::msg::Gid_<ContainerAllocator>>::other>;
  ...
  Type & set__reader_gid_seq(
    const std::vector<rmw_dds_common::msg::Gid_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmw_dds_common::msg::Gid_<ContainerAllocator>>::other> & _arg)
  {

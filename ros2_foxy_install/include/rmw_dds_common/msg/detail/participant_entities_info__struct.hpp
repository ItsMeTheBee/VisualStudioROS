...
struct ParticipantEntitiesInfo_
{
  ...
  using _node_entities_info_seq_type =
    std::vector<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>::other>;
  ...
  Type & set__node_entities_info_seq(
    const std::vector<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<rmw_dds_common::msg::NodeEntitiesInfo_<ContainerAllocator>>::other> & _arg)
  {

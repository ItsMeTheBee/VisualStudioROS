...
struct ParameterDescriptor_
{
  ...
  using _floating_point_range_type =
    rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>::other>;
  _floating_point_range_type floating_point_range;
  using _integer_range_type =
    rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::IntegerRange_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<rcl_interfaces::msg::IntegerRange_<ContainerAllocator>>::other>;
  ...
  Type & set__floating_point_range(
    const rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<rcl_interfaces::msg::FloatingPointRange_<ContainerAllocator>>::other> & _arg)
  {
    this->floating_point_range = _arg;
    return *this;
  }
  Type & set__integer_range(
    const rosidl_runtime_cpp::BoundedVector<rcl_interfaces::msg::IntegerRange_<ContainerAllocator>, 1, typename ContainerAllocator::template rebind<rcl_interfaces::msg::IntegerRange_<ContainerAllocator>>::other> & _arg)
  {

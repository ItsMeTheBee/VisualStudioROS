...
void WString__rosidl_typesupport_introspection_c__WString_init_function(
...
void WString__rosidl_typesupport_introspection_c__WString_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers WString__rosidl_typesupport_introspection_c__WString_message_members = {
  ...
  WString__rosidl_typesupport_introspection_c__WString_init_function,  // function to initialize message memory (memory has to be allocated)
  WString__rosidl_typesupport_introspection_c__WString_fini_function  // function to terminate message instance (will not free memory)
};
